...
<h2 class="header center">회원가입</h2>
<div class="row">
			...
			<div class="card-content">
				<div class="row">
					<form class="col s12" action="registerok.jsp" method="post">
						...
						<div class="row">
							<div class="input-field col s8">
								<input id="license" type="text" class="validate"> <label
									for="license">운전면허번호</label>
							</div>

						</div>
						<div class="row center-align">
							<input class="btn-large" type="submit" value="회원가입"> <a
								href="index.jsp" class="btn-large">돌아가기</a>
						</div>
					</form>
				</div>
			</div>
